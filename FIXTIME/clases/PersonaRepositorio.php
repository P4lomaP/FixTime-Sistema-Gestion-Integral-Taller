...
class PersonaRepositorio
{
    ...
    public function obtenerTipoContactoIdEmail(): int
    {
        ...
        if (!$id) {
            // Si no existe, lo creamos para robustez
    ...
    /**
     * Crea Persona + Cliente + Contacto (Email) en una transacción.
     * Devuelve el ID de Persona creada.
     */
    ...
    /** Utilidad para actualizar hash tras login */
