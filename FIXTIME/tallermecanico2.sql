-- =========================================================
-- BORRADO PREVIO (en orden para evitar errores de FK)
-- =========================================================
...
('Punto', 1),
('Corolla', 2);
INSERT INTO Automoviles (descripcion, anio, km, color, Modelo_Automovil_id) VALUES
('Fiat Punto', '2015', '85000', 'Rojo', 1),
('Toyota Corolla', '2018', '65000', 'Negro', 2);
...
INSERT INTO Estados_Turnos (descripcion) VALUES ('Pendiente'), ('Confirmado'), ('Cancelado');
