...
CREATE TABLE Contacto_Persona (
    ...
    UNIQUE KEY uq_tipo_valor (Tipo_Contacto_id, valor)
) ENGINE=InnoDB;
...
-- Tus INSERTs originales de Turnos (no requieren motivo porque tiene DEFAULT '')
...
INSERT INTO Personas (nombre, apellido, dni, contrasenia)
VALUES ('RICKY', 'Adm', '45170425', '$2y$10$2wc0Lxevs02iLd8Spz9.6eGLmLTUOM842GVZUlloxR7opeV51Cvge');
...
INSERT INTO Administradores (Persona_id)
SELECT id FROM Personas WHERE dni = '45170425';
...
WHERE NOT EXISTS (SELECT 1 FROM Cargos WHERE descripcion='Administrador');

ALTER TABLE Empleados       ADD COLUMN fecha_baja DATE NULL AFTER Cargo_id;

ALTER TABLE Administradores 
ADD COLUMN fecha_baja DATETIME NULL AFTER Persona_id;

ALTER TABLE Turnos 
ADD COLUMN recordatorio_enviado TINYINT(1) DEFAULT 0 AFTER Estado_Turno_id;
INSERT INTO Turnos (fecha_turno, hora_turno, Estado_Turno_id, Automovil_id, motivo, descripcion)
VALUES (DATE_ADD(CURDATE(), INTERVAL 1 DAY), '10:00:00', 1, 1, 'Service general', 'Chequeo completo');


INSERT INTO Turnos (fecha_turno, hora_turno, Estado_Turno_id, Automovil_id, motivo, descripcion)
VALUES (DATE_ADD(CURDATE(), INTERVAL 1 DAY), '20:30:00', 1, 1, 'Service de prueba', 'Chequeo de recordatorio');
INSERT INTO Turnos (fecha_turno, hora_turno, Estado_Turno_id, Automovil_id, motivo, descripcion)
VALUES (DATE_ADD(CURDATE(), INTERVAL 1 DAY), '20:30:00', 1, 1, 'Service de prueba', 'Chequeo de recordatorio');

INSERT INTO Estados_Turnos (descripcion) VALUES ('pendiente reasignacion');

-- Registrar quién recepcionó el vehículo (opcional pero recomendado)
ALTER TABLE Ordenes_Reparaciones
  ADD COLUMN recepcionista_id INT NULL AFTER Empleado_id,
  ADD CONSTRAINT fk_or_recepcionista
    FOREIGN KEY (recepcionista_id) REFERENCES Empleados(id);
    
    
    ALTER TABLE ordenes_reparaciones
  ADD COLUMN Turnos_id INT NULL AFTER presupuesto_id,
  ADD INDEX idx_or_turno (Turnos_id);

-- (Opcional pero recomendado)
ALTER TABLE ordenes_reparaciones
  ADD CONSTRAINT fk_or_turno
