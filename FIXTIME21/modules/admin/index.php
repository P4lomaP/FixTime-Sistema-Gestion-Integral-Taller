...
<title>Fixtime — Panel del Administrador</title>
  ...
  <main class="main">
    ...
    <section class="card">
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn" href="<?= $base ?>/modules/admin/calendario.php">Configurar calendario</a>
        <a class="btn" href="<?= $base ?>/modules/admin/vehiculos.php">+ Vehículo de Clientes</a>
      </div>
...
(function () {
  ...
  // Click en hamburguesa -> TOGGLE (abrir/cerrar)
